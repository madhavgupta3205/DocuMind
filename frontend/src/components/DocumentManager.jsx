        ...
        <div className="px-6 py-4 bg-gray-50 border-b border-gray-200">
          ...
          <div className="flex gap-3 items-start">
            ...
            <button
              ...
              className="px-6 py-2 bg-blue-600 text-white rounded-md font-medium hover:bg-blue-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors flex items-center gap-2"
            >
              {uploading && (
              ...
              {uploading ? "Processing document... (this may take 1-2 minutes)" : "Upload"}
            </button>
          </div>
